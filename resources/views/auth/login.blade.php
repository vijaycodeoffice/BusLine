  ...
  <body class="bg-light-gray" id="body">
      ...
      <div class="row justify-content-center mt-5">
        ...
        @endif   
              ...
              <form name="myform" method="POST" action="{{ route('admin-login') }}" >
                @csrf
                <div class="row">
...
<div id ="errors"></div>
    ...
    if(document.myform.email.value == ""){   //checking if the form is empty
	 ...
	 if(document.myform.password.value == ""){   //checking if the form is empty
         document.getElementById('errorspass').innerHTML="*Please enter a password*";
                //displaying a message if the form is empty
    }else{
		
		document.getElementById('errorspass').innerHTML="";
